...
import com.android.settings.display.ForceAmbientForMediaPreferenceController;
...
public class LockscreenDashboardFragment extends DashboardFragment
    ...
    public void onAttach(Context context) {
        ...
        use(ForceAmbientForMediaPreferenceController.class).setConfig(getConfig(context));
